    ...
    <div className="mx-auto max-w-3xl px-4 py-10 text-sm leading-relaxed text-ink">
      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <p className="mt-2">11.7. O Encarregado pelo Tratamento de Dados Pessoais (DPO) do ULTRAPT, para os fins do art. 41 da LGPD, é o próprio Alex Guimarães Dos Santos (CPF 075.316.036-67), podendo ser contatado pelo e-mail <a href="mailto:privacidade@ultrapt.com.br" className="text-accent hover:underline">privacidade@ultrapt.com.br</a>.</p>
          <p className="mt-2">11.8. Política de retenção: (i) durante a vigência do Contrato, os dados são mantidos integralmente; (ii) após exclusão da Conta pelo PERSONAL TRAINER, os dados pessoais são anonimizados imediatamente, sendo retidos apenas os registros fiscais (pagamentos e identificadores de cobrança) pelo prazo de 5 (cinco) anos, em cumprimento ao Código Tributário Nacional; (iii) backups são purgados em até 30 dias adicionais; (iv) logs técnicos com IP e metadados de requisição são retidos por 90 dias para fins de segurança e prevenção a fraude.</p>
          <p className="mt-2">11.9. Para detalhes sobre tratamento de dados, finalidades, subprocessadores, transferência internacional e exercício dos direitos do titular, consultar a <Link href="/privacidade" className="text-accent hover:underline">Política de Privacidade</Link>.</p>
        </section>
